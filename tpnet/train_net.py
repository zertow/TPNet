...
import detectron2.utils.analysis as ana
...
def main(args):
    ...
    if args.eval_only:
        ...
        #print(type(model))
        #tensor = torch.rand(3, 1024, 1024)
        #x = ({"image":tensor},)
#
        model.eval()
        #ret = ana.FlopCountAnalysis(model, x)
        ##ret = ana.flop_count_operators(model,x)
#
        #print("FLOPs: ", ret.total())
        #print(ret)
        #1/0
